...
{
    public sealed class ImportContactJob
    {
        private readonly IPushNotificationManager _pushNotificationManager;
        private readonly ICustomerDataExporter _customerDataExporter;

        public ImportContactJob(IPushNotificationManager pushNotificationManager, ICustomerDataExporter customerDataExporter)
        {
