...
namespace VirtoCommerce.CustomerExportImportModule.Tests
{
    ...
    public class CsvClassMapsTest
    {
        ...
        public void Map_OrganizationWithDynamicProperty_Success()
        {
            ...
            //Assert
            var expected = "Organization Id;Organization Outer Id;Organization Name;Parent Organization Name;Parent Organization Id;Parent Organization Outer Id;Phones;Business category;Description;Organization Groups;Address Type;Address First Name;Address Last Name;Address Country;Address Region;Address City;Address Address Line1;Address Address Line2;Address Zip Code;Address Email;Address Phone;Size\r\n"
